...
scr_cleaned <- read.xlsx2('/Users/alebedev/Dropbox/HUDdata/HUD_anonymized_cleaned.xlsx',1)[,c('ScreenID','surveyfoundout')]
...
write.xlsx2(descrTable, file='/Users/alebedev/Dropbox/HUDdata/descrTable.xlsx')              
