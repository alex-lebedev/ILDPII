...
points(jitter(cbind(1, dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='NP'),'RT']),5), col='#00BFC4', pch=16, cex=1)
points(cbind(1, mean(dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='NP'),'RT'])),col='#00BFC4', pch=16, cex=3)
points(jitter(cbind(2, dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='PP'),'RT']),5), col='#F8766D', pch=16, cex=1)
points(cbind(2, mean(dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='PP'),'RT'])),col='#F8766D', pch=16, cex=3)
points(jitter(cbind(3, dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='NP'),'RT']),5), col='#00BFC4', pch=17, cex=1)
points(cbind(3, mean(dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='NP'),'RT'])),col='#00BFC4', pch=17, cex=3)
points(jitter(cbind(4, dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='PP'),'RT']),5), col='#F8766D', pch=17, cex=1)
points(cbind(4, mean(dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='PP'),'RT'])),col='#F8766D', pch=17, cex=3)
...
boxplot(dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='NP'),'RT'],dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='PP'),'RT'],
        ...
        ylim=c(0,3),range=100)
points(jitter(cbind(1, dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='NP'),'RT']),5), col='#00BFC4', pch=16, cex=1)
points(cbind(1, mean(dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='NP'),'RT'])),col='#00BFC4', pch=16, cex=3)
points(jitter(cbind(2, dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='PP'),'RT']),5), col='#F8766D', pch=16, cex=1)
points(cbind(2, mean(dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='PP'),'RT'])),col='#F8766D', pch=16, cex=3)
points(jitter(cbind(3, dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='NP'),'RT']),5), col='#00BFC4', pch=17, cex=1)
points(cbind(3, mean(dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='NP'),'RT'])),col='#00BFC4', pch=17, cex=3)
points(jitter(cbind(4, dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='PP'),'RT']),5), col='#F8766D', pch=17, cex=1)
points(cbind(4, mean(dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='PP'),'RT'])),col='#F8766D', pch=17, cex=3)
# ACCURACIES:
...
points(jitter(cbind(1, dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='NP'),'Acc']),5), col='#00BFC4', pch=16, cex=1)
points(cbind(1, median(dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='NP'),'Acc'])),col='#00BFC4', pch=16, cex=3)
points(jitter(cbind(2, dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='PP'),'Acc']),5), col='#F8766D', pch=16, cex=1)
points(cbind(2, median(dots[(dots$BGD=='dynamic' & dots$SPEED=='slow' & dots$group=='PP'),'Acc'])),col='#F8766D', pch=16, cex=3)
points(jitter(cbind(3, dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='NP'),'Acc']),5), col='#00BFC4', pch=17, cex=1)
points(cbind(3, median(dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='NP'),'Acc'])),col='#00BFC4', pch=17, cex=3)
points(jitter(cbind(4, dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='PP'),'Acc']),5), col='#F8766D', pch=17, cex=1)
points(cbind(4, median(dots[(dots$BGD=='dynamic' & dots$SPEED=='fast' & dots$group=='PP'),'Acc'])),col='#F8766D', pch=17, cex=3)
...
points(jitter(cbind(1, dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='NP'),'Acc']),5), col='#00BFC4', pch=16, cex=1)
points(cbind(1, median(dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='NP'),'Acc'])),col='#00BFC4', pch=16, cex=3)
points(jitter(cbind(2, dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='PP'),'Acc']),5), col='#F8766D', pch=16, cex=1)
points(cbind(2, median(dots[(dots$BGD=='static' & dots$SPEED=='slow' & dots$group=='PP'),'Acc'])),col='#F8766D', pch=16, cex=3)
points(jitter(cbind(3, dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='NP'),'Acc']),5), col='#00BFC4', pch=17, cex=1)
points(cbind(3, median(dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='NP'),'Acc'])),col='#00BFC4', pch=17, cex=3)
points(jitter(cbind(4, dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='PP'),'Acc']),5), col='#F8766D', pch=17, cex=1)
points(cbind(4, median(dots[(dots$BGD=='static' & dots$SPEED=='fast' & dots$group=='PP'),'Acc'])),col='#F8766D', pch=17, cex=3)
