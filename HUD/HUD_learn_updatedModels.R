...
### Run Model:
mysamples <- stan(file='/Users/alebedev/GitHub/ILDPII/stan_models/RW_instr_multipleSubj_initFree_allEVs.stan',   
                  data=dataList, 
                  #                pars=parameters,
...
save('mysamplesHUD', 'rhos', 'alpha', 'evDelta',
     file= '/Users/alebedev/Documents/Projects/HUD/pupillometry/mysamplesHUD_NP_allEVs.rda')
...
mysamplesHUD <- mysamples
save('mysamplesHUD', 'rhos', 'alpha', 'evDelta',
     file= '/Users/alebedev/Documents/Projects/HUD/pupillometry/mysamplesHUD_PP_allEVs.rda')
